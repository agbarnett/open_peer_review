...
# get the model, from 2_stability_selection.R
load('results/2_ests_stability.RData')
...
cplot = ggplot(data = to_plot, aes(x=cookd))+
  ...
  g.theme
cplot
ggsave('figures/3_cooks_distance.jpg', cplot, width = 4.2, height=4.2, units='in', dpi=500)
...
pplot
ggsave('figures/3_fit_vs_observed_dots.jpg', pplot, width = 5.4, height=4.8, units='in', dpi=500)
...
bplot
#
jpeg('figures/3_fit_vs_observed.jpg', width = 5.4, height=4.8, units='in', res=500)
