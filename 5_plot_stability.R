...
# export
ggsave('figures/5_stability_estimates.jpg', cplot_column, width = 5.8, height=7.2, units='in', dpi=500)
...
ggsave('figures/5_stability_estimates_square.jpg', cplot_square, width = 7.2, height=7.2, units='in', dpi=500)
...
cplot2
# export
ggsave('figures/5_stability_country.jpg', cplot2, width = 4.7, height=4.5, units='in', dpi=500)
# version for slide
